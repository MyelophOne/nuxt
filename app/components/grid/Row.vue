...
const classes = computed(() => [
	ROW_BASE,
	{
		"layout-row-root relative": bgStyles.value || hasVideo.value,
	},
	...
	props.size && ["mx-auto", CONTAINER_MAX_WIDTH[props.size]],
	props.equalHeight
		? ["md:items-stretch", "group/equal"]
		: FLEX_ALIGN[props.align],
...
.layout-row-root.has-gradient-overlay::before {
